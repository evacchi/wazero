...
type FS interface {
	...
	// Utimesns set file access and modification times on a path relative to
	...
	// # Notes
	//
	//   - This is similar to syscall.Utimesns, except that doesn't have flags to
	...
	Utimesns(path string, times *[2]syscall.Timespec, symlinkFollow bool) error
}
